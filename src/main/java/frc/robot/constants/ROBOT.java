...
public class ROBOT {
  ...
  // TODO confirm this
  public static final double driveBaseWidth = Units.inchesToMeters(29.0);
  public static final double driveBaseLength = Units.inchesToMeters(28.0);
  public static final double robotHeight = Units.inchesToMeters(25.0);
  ...
  public static void initFortissimo() {
  ...
  public static void initConstants() {
    ...
    if (RobotController.getSerialNumber().equals(ROBOT_ID.FORTE.getSerial())) {
      ...
      initSim();
    } else if (RobotController.getSerialNumber().equals(ROBOT_ID.FORTISSIMO.getSerial())) {
      alert.setText("Setting Robot Constants for Fortissimo");
      initSim();
    } else {
      alert =
          new Alert(
